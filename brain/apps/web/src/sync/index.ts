 ...
 * пространства (`security/grants.ts`), тем же синком, что и данные.
 */
  ...
  return (error) => {
    if (error instanceof CryptoError) {
      ...
      console.warn(
        ...
        + 'Если это новое устройство — подключите его: на основном устройстве '
        + 'экран «Доступ» → «Пригласить», ссылку или QR откройте здесь.',
      );
      return;
    }
