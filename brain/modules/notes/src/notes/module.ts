 ...
 *
 * Тело заметки пока хранится строкой markdown, а не документом
 * `@robonen/writekit` (docs/00-plan.md, Р6 и риск «два CRDT»): подробности и
 * цена решения — в шапке `db/models.ts`.
 */
